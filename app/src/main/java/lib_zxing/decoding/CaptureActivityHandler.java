...
import lib_zxing.view.ViewfinderResultPointCallback;
import lib_zxing.view.ViewfinderView;
import zeller.com.opencvexample.R;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.auto_focus) {
            ...
            /***********************************************************************/
        }  else if (message.what == R.id.opencv_decode_succeeded) {
            Log.d(TAG, "Got decode succeeded message");
            state = State.SUCCESS;
            Bundle bundle = message.getData();
            ...
            Bitmap barcode = bundle == null ? null :
                    (Bitmap) bundle.getParcelable(DecodeThread.BARCODE_BITMAP);//���ñ����߳�
            Result result = new Result((String) message.obj, null, null,null);
            fragment.handleDecode(result, barcode);//���ؽ��
            /***********************************************************************/
